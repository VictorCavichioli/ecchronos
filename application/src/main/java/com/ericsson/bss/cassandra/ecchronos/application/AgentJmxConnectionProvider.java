...
import com.ericsson.bss.cassandra.ecchronos.connection.impl.DistributedJmxConnectionProvider;

public class AgentJmxConnectionProvider implements JmxConnectionProvider
{
    ...
    public AgentJmxConnectionProvider(
        ...
        final AgentNativeConnectionProvider agentNativeConnectionProvider) throws IOException
    {
        ...
        myDistributedJmxConnectionProvider = new DistributedJmxConnectionProvider(
            agentNativeConnectionProvider.getSession(),
            agentNativeConnectionProvider.getNodesList(),
            credentials,
            tls);
    }
    ...
    {
        return myDistributedJmxConnectionProvider.getJmxConnector();
    }

    @Override
    public final void close() throws IOException
    {
        myDistributedJmxConnectionProvider.close();
    }
