...
public final class LockCache
{
            ...
            throws LockException
    {
        ...
        try
        {
            return myLockSupplier.getLock(nodeID, dataCenter, resource, priority, metadata);
        }
    ...
    {
        DistributedLock getLock(UUID nodeID, String dataCenter, String resource, int priority, Map<String, String> metadata)
                throws LockException;
    }
