...
public class DistributedJmxProxyFactoryImpl implements DistributedJmxProxyFactory
{
    ...
    public DistributedJmxProxy connect() throws IOException
    {
        try
        {
            return new InternalDistributedJmxProxy(myDistributedJmxConnectionProvider);
        }
    ...
    private final static class InternalDistributedJmxProxy implements DistributedJmxProxy
    {
        private final DistributedJmxConnectionProvider myDistributedJmxConnectionProvider;
        ...
        public List<String> getLiveNodes(final UUID nodeID)
        {
            try
            {
                return (List<String>) myDistributedJmxConnectionProvider
                        .getJmxConnector(nodeID)
                ...
                final Map<String, String> options)
        {
            try
            {
                return (int) myDistributedJmxConnectionProvider
                        .getJmxConnector(nodeID)
        ...
        {
            for(Map.Entry<UUID, JMXConnector> entry : myDistributedJmxConnectionProvider.getJmxConnections().entrySet())
            {
                ...
                final TableReference tableReference)
        {
            try
            {
                ...
                return (Long) myDistributedJmxConnectionProvider
                        .getJmxConnector(nodeID)
                ...
                final TableReference tableReference)
        {
            try
            {
                ...
                List<CompositeData> compositeDatas = (List<CompositeData>) myDistributedJmxConnectionProvider
                        .getJmxConnector(nodeID)
                ...
                final TableReference tableReference)
        {
            try
            {
                ...
                return (double) myDistributedJmxConnectionProvider
                        .getJmxConnector(nodeID)
        ...
        public String getNodeStatus(final UUID nodeID)
        {
            try
            {
                return (String) myDistributedJmxConnectionProvider
                        .getJmxConnector(nodeID)
