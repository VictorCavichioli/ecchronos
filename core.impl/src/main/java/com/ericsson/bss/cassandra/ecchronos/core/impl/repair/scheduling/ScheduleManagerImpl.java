...
import com.ericsson.bss.cassandra.ecchronos.core.lock.DistributedLock;
import com.ericsson.bss.cassandra.ecchronos.core.lock.LockFactory;
...
public final class ScheduleManagerImpl implements ScheduleManager, Closeable
{
    ...
    private void createScheduleFutureForNodeIDList(Builder builder)
    {
    ...
    private class JobRunTask implements Runnable
    {
        ...
        private JobRunTask(UUID nodeID)
        {
            this.nodeID = nodeID;
        }
                ...
                final ScheduledTask task)
        {
            ...
            try (DistributedLock lock = task.getLock(nodeID, myLockFactory))
            {
