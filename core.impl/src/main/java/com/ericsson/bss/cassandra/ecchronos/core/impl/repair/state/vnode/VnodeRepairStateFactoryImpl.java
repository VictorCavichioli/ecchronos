 ...
 */
package com.ericsson.bss.cassandra.ecchronos.core.impl.repair.state.vnode;
...
public class VnodeRepairStateFactoryImpl implements VnodeRepairStateFactory
{
     ...
     */
    @Override
    public VnodeRepairStates calculateState(
            final Node node,
            final TableReference tableReference,
            final long to,
            final long from)
    ...
    public VnodeRepairStates calculateClusterWideState(
            ...
            final long from)
    {
        Map<LongTokenRange, ImmutableSet<DriverNode>> tokenRanges = myReplicationState.getTokenRanges(tableReference, currentNode);
