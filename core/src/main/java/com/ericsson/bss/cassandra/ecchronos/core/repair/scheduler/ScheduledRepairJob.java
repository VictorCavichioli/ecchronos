...
import com.ericsson.bss.cassandra.ecchronos.core.lock.RepairLockFactory;
import com.ericsson.bss.cassandra.ecchronos.core.lock.RepairLockFactoryImpl;
...
import com.ericsson.bss.cassandra.ecchronos.core.lock.RepairLockType;
...
public abstract class ScheduledRepairJob extends ScheduledJob
{
    ...
    private final RepairLockType myRepairLockType = RepairLockType.valueOf("vnode".toUpperCase(Locale.US));
    ...
    public boolean equals(final Object o)
    {
        ...
        return Objects.equals(myTableReference, that.myTableReference) && Objects.equals(
                ...
                myRepairPolicies, that.myRepairPolicies);
    }
