...
public abstract class ScheduledTask
{
     ...
     */
    public DistributedLock getLock(UUID nodeID, final LockFactory lockFactory) throws LockException
    {
        return lockFactory.tryLock(nodeID, null, DEFAULT_SCHEDULE_RESOURCE, myPriority, new HashMap<>());
    }
}
